    ...
    for nCount in range(1,20):
        if nCount != 1:
            ...
            if (nCount % 2) == 0: 
                ...
                sizes[1] *= 2
                ncells[1] *= 2
        case = nodeCounts[curr_case]
        if (curr_nodeCount == case ):
            curr_case += 1
            print("Setting {} nodes case".format(case))
