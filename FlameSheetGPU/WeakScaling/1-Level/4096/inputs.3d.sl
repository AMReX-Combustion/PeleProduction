...
geometry.prob_hi   = .032 .016 .016
geometry.prob_hi   = 1.536 2.048 .024
...
amr.n_error_buf     = 8 1 1 2 # number of buffer cells in error est
...
amr.plot_file       = plt
amr.plot_int        = 100
amr.derive_plot_vars=rhoRT mag_vort avg_pressure gradpx gradpy diveru mass_fractions molweight rhominsumrhoY cc_transport_coeffs cpmix enthalpy 
...
amr.flame_tracer.value_greater = 1.e-9
